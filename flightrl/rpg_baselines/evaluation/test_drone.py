...
def main():   
    ...
    high_level_planner.scale_goal(np.array([0.2, 0.2, 0.5]))
    high_level_planner.shift_goal_origin(np.array([0.0, 0.0, 2.0]))
    ...
    while n_roll < num_rollouts:
        ...
        # possible_goals = np.array([[5.0, 0.0, 1.0], 
        #                         [-5.0, 0.0, 1.0], 
        #                         [0.0, 5.0, 1.0],
        #                         [0.0, -5.0, 1.0], 
        #                         [0.0, 0.0, 1.0], 
        #                         [-5.0, 0.0, 6.0]],
        #                         dtype=np.float32)
        # current_goal = np.array(possible_goals[1, :], dtype=np.float32)
    ...
    plt.tight_layout()
    plt.savefig("./test_drone_result.png")
    plt.show()
